...
| TC-NEWS-CP-05      | Полный E2E сценарий удаления новости                                        | Запланировано        | Ключевой E2E-сценарий (Удаление)     |
| TC-NEWS-EDIT-01    | Полный E2E сценарий редактировании новости с проверкой предзаполнения полей | Запланировано        | Ключевой E2E-сценарий (Редактирование) |
...
| TC-NEWS-CREATE-12 | Валидация длины поля "Title" из спецсимволов                     | Запланировано        | Проверка дефекта (баг)      |
